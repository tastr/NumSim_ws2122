...
StaggeredGrid::StaggeredGrid(Settings settings)
    : pressure({settings.nCells[0] + 2, settings.nCells[1] + 2}, settings, {0.5, 0.5}), velocity_X({settings.nCells[0] + 1, settings.nCells[1] + 2}, settings, {0, 0.5}), velocity_Y({settings.nCells[0] + 2, settings.nCells[1] + 1}, settings, {0.5, 0}), type({settings.nCells[0] + 2, settings.nCells[1] + 2}, settings, {0, 0}), settings_(settings)
