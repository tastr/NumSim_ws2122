...
:pressure({partitioning.nCells()[0]+3, partitioning.nCells()[1]+3}, {1.5,1.5}, {settings.physicalSize[0] / (1.0*partitioning.nCellsGlobal()[0]), settings.physicalSize[1] / (1.0*partitioning.nCellsGlobal()[1])}) 
,velocity_X({partitioning.nCells()[0]+3 - partitioning.ownPartitionContainsRightBoundary(), partitioning.nCells()[1]+3}, {1,1.5}, {settings.physicalSize[0] / (1.0*partitioning.nCellsGlobal()[0]), settings.physicalSize[1] / (1.0*partitioning.nCellsGlobal()[1])})
,velocity_Y({partitioning.nCells()[0]+3, partitioning.nCells()[1]+3 - partitioning.ownPartitionContainsTopBoundary()}, {1.5,1}, {settings.physicalSize[0] / (1.0*partitioning.nCellsGlobal()[0]), settings.physicalSize[1] / (1.0*partitioning.nCellsGlobal()[1])})
,settings_(settings)
